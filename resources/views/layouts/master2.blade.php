            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{asset('public/backend')}}/buttons.html">Buttons</a>
                        <a class="collapse-item" href="{{asset('public/backend')}}/cards.html">Cards</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{asset('public/backend')}}/utilities-color.html">Colors</a>
                        <a class="collapse-item" href="{{asset('public/backend')}}/utilities-border.html">Borders</a>
                        <a class="collapse-item" href="{{asset('public/backend')}}/utilities-animation.html">Animations</a>
                        <a class="collapse-item" href="{{asset('public/backend')}}/utilities-other.html">Other</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{asset('public/backend')}}/login.html">Login</a>
                        <a class="collapse-item" href="{{asset('public/backend')}}/register.html">Register</a>
                        <a class="collapse-item" href="{{asset('public/backend')}}/forgot-password.html">Forgot Password</a>
                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header">Other Pages:</h6>
                        <a class="collapse-item" href="{{asset('public/backend')}}/404.html">404 Page</a>
                        <a class="collapse-item" href="{{asset('public/backend')}}/blank.html">Blank Page</a>
                    </div>
                </div>
            </li>
