...
{!! Form::open(['route'=> 'user_store','method'=>'post']) !!} 
  ...
  <div class="form-group">
    <label for="user_id">1.User_ID<span class="text-danger">*</span>:</label>
    
    <input type="text" class="form-control" id="user_id" placeholder="Enter User_ID" name="user_id">
  </div>

<div class="form-group">
    <label for="user_id">2.Admin_ID<span class="text-danger">*</span>:</label>
  ...
  <div class="form-group">
    <label for="group_id">3.Group_ID<span class="text-danger">*</span>:</label>
  ...
  <div class="form-group">
    <label for="group">4.Group<span class="text-danger">*</span>:</label>
...
<div class="form-group">
    <label for="uname">5.Name<span class="text-danger">*</span>:</label>
